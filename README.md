...
**当前版本：v4.8.0** · [在线访问 →](https://wuyi1111.github.io/xixi-cosmos/)
...
### v4.8.0 · 2026-05-20 — 舒缓调息功能全面升级

- 新增设置页面，支持选择时长（1/2/3分钟）和速率（慢/中/快）
- 宇宙之花/光晕动画：三层径向渐变光晕随呼吸缩放，配合缓动效果
- 触觉反馈：吸气时轻振30ms，形成节拍感
- 暂停功能：轻点暂停/继续，暂停时显示暂停状态
- 下滑结束：触摸下滑超过50px可提前结束练习
- 完成页面：显示本次呼吸时长，2秒后自动返回主界面
- 自动适配深色/浅色主题

### v4.7.0 · 2026-05-19 — 星愿池添加密码验证

- “星尘·去星愿池”按钮添加密码验证，访问密码为 186638
- 密码弹窗样式与项目整体风格保持一致，支持深色/浅色主题
- 密码错误时显示红色提示信息
- 点击弹窗外部或右上角 X 可关闭密码验证界面
