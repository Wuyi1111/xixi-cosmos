  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center pb-[calc(env(safe-area-inset-bottom)+0.5rem)] pointer-events-none">
        <nav className={`pointer-events-auto flex items-center justify-around gap-1 rounded-full mx-4 px-4 py-2.5 backdrop-blur-xl border w-full max-w-sm transition-colors duration-500 ${
          isDark
