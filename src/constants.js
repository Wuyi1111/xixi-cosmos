...
export const EMOTIONS = [
  ...
  { id: 'unclear', name: '迷茫', symbol: '🌫️', color: '#E6E6FA', texts: ['思绪像迷雾一样，暂时看不清方向。', '没关系，慢慢来，答案会浮现的。', '有些情绪不需要急着定义，感受就好。'] },
  { id: 'joyful', name: '愉悦', symbol: '😊', color: '#FFD700', texts: ['今天心情很好，充满了快乐和满足。', '把这份喜悦珍藏起来，晚安好梦。', '你的笑容，是今夜最亮的星星。'] },
  { id: 'anxious', name: '焦虑', symbol: '💭', color: '#FFA07A', texts: ['心里有些不安，像有小鼓在敲。', '深呼吸，我们一起面对，不用害怕。', '焦虑会过去，夜晚会抚平一切。'] },
  { id: 'tired', name: '疲倦', symbol: '😴', color: '#B0C4DE', texts: ['身体和心里都感到疲惫。', '辛苦了，今天你已经做得很好了。', '好好休息，明天又是新的一天。'] }
];
